            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-md-3 text-center">
                            ...
                            <span class="badge bg-{{ $user->role == 'admin' ? 'danger' : ($user->role == 'gerente' ? 'warning' : 'primary') }}">
                                @switch($user->role)
                                    ...
                                    @case('garcom') Garçom/Garçonete @break
                        ...
                        <div class="col-md-9">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <p><strong>Telefone:</strong><br>{{ $user->phone ?? 'Não informado' }}</p>
                                </div>
                                <div class="col-md-6">
                                    <p><strong>CPF:</strong><br>{{ $user->cpf ?? 'Não informado' }}</p>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-12">
                                    <p><strong>Endereço:</strong><br>{{ $user->address ?? 'Não informado' }}</p>
                                </div>
                                <div class="col-md-6">
                    ...
                    <form method="POST" action="{{ route('profile.update') }}">
                        ...
                        <h5 class="mb-3"><i class="fas fa-edit me-2"></i>Editar Informações</h5>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <small class="text-muted">Obrigatória para alterar a senha</small>
